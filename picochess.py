...
def main():
    ...
    def expired_fen_timer():
        ...
        if error_fen:
            ...
            ## Flexible ponder mode: Allow any position changes and start calcualting again
            if interaction_mode == Mode.PONDER:
                if try_again == 0:
                    ...
                    logging.debug('Molli Start flexible Ponder with fen: %s', fen_save)
                    fen = fen_save
                    fen2 = fen_save
            ...
            ## molli no error in new ponder mode
                DisplayMsg.show(Message.WRONG_FEN())
                DisplayMsg.show(Message.EXIT_MENU())
        ...
        try:
            ...
            if False:  # switch-case
                ...
                if newgame:
                    ...
                    legal_fens_after_cmove = [] # molli
                    is_out_of_time_already = False #molli
                    if interaction_mode == Mode.PONDER: ##molli
